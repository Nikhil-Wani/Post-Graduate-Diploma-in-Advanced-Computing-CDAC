...
if(isset($_POST['submit'])){
	...
	if($print_again!=0)
	{
		...
		if($_COOKIE['count_regiser']==""){
				setcookie("count_regiser",1,time()+3600,"/","",0);
				setcookie("name",$name);
				setcookie("email",$email);
				setcookie("age",$age);
				setcookie("Addr1",$addr1);
				setcookie("Addr2",$addr2);
				setcookie("city",$city);
			...
			echo "<font color='red'><h2>Already some user Registerd from this browser. you cannot do one more registeration from this browser</h2></font>";
		}
